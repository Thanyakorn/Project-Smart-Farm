...
int Rainwater = 0;        // ตัวแปรค่า Analog
...
void loop(){
  ...
  Rainwater = analogRead(Detection);
  outputValu = map(Rainwater, 0, 1023, 100, 0);
  ...
  if (outputValu > 10) {         //ไฟจะติดเมื่อมากกว่า 10
